...
class OrderItemServiceImplTest {
    ...
    void testGetOrderItemList() {
        when(orderItemRepository.findOrderItemsByOrderId(1L)).thenReturn(List.of(orderItemUpdated));
        when(orderItemMapper.toOrderItemDtoList(List.of(orderItemUpdated))).thenReturn(List.of(orderItemDto));

        assertEquals(orderItemService.getOrderItemList(1L), List.of(orderItemDto));
    }
